                        ...
                        while($row_pro = mysqli_fetch_array($run_pro))
                        {
                            ...
                            echo "
                                ...
                                <div class = 'col-md-6 col-lg-6'>
                                        ...
                                        <img src = 'admin_area/product_images/$pro_image' width='350' height='350' class='img-thumbnail'>                                                                   

                                        <p><b> Price: £ $pro_price</b></p>
                                                                                                                        
                                        <a href='index.php' class='btn btn-danger style='float:left'>Go Back<i class='fa fa-undo ml-2'></i></a>
                                ...
                                <div class = 'col-md-6 col-lg-6'>
                                    ...
                                    <h2 class><strong>$pro_title</strong></h3>
                                    
                                    <p class='mb-10'>$pro_desc</p>
